      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-7xl font-bold leading-tight mb-8">
            Boosting your Energy capacity intravenously
            <br />
            with a software-only solution
          </h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
            Connecting distributed energy resources to wholesale energy markets with our proprietary software to reduce blackouts, costs and pollution - all within 2 seconds
          </p>
